...
//    Image image = new Image.asset("images/battery_empty.png");
...
//        Paint()..style = PaintingStyle.stroke);
  ...
  _drawWave(Canvas canvas, Size size, double offset, Color color) {
    ...
    path.close();
    canvas.clipRRect(new RRect.fromRectAndRadius(new Rect.fromLTRB(3, 10, rect.right - 3, rect.bottom - 3), Radius.circular(0.0)));
